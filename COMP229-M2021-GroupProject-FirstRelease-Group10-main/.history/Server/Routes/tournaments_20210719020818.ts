          ...
          // show the edit view
           // instantiate a new tournament Item
            ...
            if(match === "one")
            {
              ...
              {
                updatedTournamentItem.WinnerFirstQuarterFinal = updatedTournamentItem.PlayerOne;
              }

              else
              {
                updatedTournamentItem.WinnerFirstQuarterFinal = updatedTournamentItem.PlayerTwo ;
              }
