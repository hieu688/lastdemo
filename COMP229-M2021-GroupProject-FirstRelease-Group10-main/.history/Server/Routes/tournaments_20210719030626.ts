      ...
      else
      {
          // show the edit view
           // instantiate a new tournament Item
            ...
            {
              updatedTournamentItem.WinnerFirstQuarterFinal  = req.body.scoreone;
              updatedTournamentItem.WinnerFirstQuarterFinal  = req.body.scoretwo;
              //Move winner to the next round
              if(updatedTournamentItem.WinnerFirstQuarterFinal  > updatedTournamentItem.WinnerSecondQuarterFinal )
              {
