...
router.post('/add', (req, res, next) => {
  ...
  ({
    ...
    "WinnerFirstQuarterFinal": req.body.startdate,
    "WinnerSecondQuarterFinal": req.body.startdate,
    "WinnerThirdQuarterFinal": req.body.startdate,
    "WinnerFourthQuarterFinal": req.body.startdate,
    "WinnerFirstSemiFinal": req.body.startdate,
    "WinnerFirstSecondFinal": req.body.startdate,
    "WinnerFinal": req.body.startdate,
   });
