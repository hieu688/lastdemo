          ...
          // show the edit view
           // instantiate a new tournament Item
              ...
              if(match === "one")
            {
              ...
              {
                updatedTournamentItem.WinnerFirstQuarterFinal = tournamentItemToEdit[0].PlayerOne;
              }

              else
              {
                updatedTournamentItem.WinnerFirstQuarterFinal = tournamentItemToEdit[0].PlayerTwo;
              }
